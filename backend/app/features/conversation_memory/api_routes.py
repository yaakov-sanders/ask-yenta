...
async def get_chat_history(
    ...
    messages, total_count = await get_conversation_history(
        db=session,
        user_id=user_id,
        limit=limit,
        offset=offset
...
async def chat_with_memory(
    ...
    memory = await get_conversation_memory(session, user_id)
    ...
    user_profile = await get_llm_profile(session, user_id)
    ...
    await update_conversation_memory(session, user_id, new_message, reply, updated_summary)
