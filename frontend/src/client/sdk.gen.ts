...
export class ChatService {
     ...
     * @throws ApiError
     */
    public static getChatHistory(data: ChatGetChatHistoryData): CancelablePromise<ChatGetChatHistoryResponse> {
     ...
     * @throws ApiError
     */
    public static chatWithMemory(data: ChatChatWithMemoryData): CancelablePromise<ChatChatWithMemoryResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/chat',
